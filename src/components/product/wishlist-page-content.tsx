...
export function WishlistPageContent() {
  ...
  const hydrated = useWishlistStore((state) => state.hasHydrated);
  if (!hydrated)
    return (
      <div className="glass-panel mt-10 rounded-2xl p-8 text-center text-[#334f6d]">
  ...
  if (!items.length)
    return (
      <div className="glass-panel mt-10 rounded-2xl p-10 text-center">
        <Heart className="mx-auto text-[#3051a0]" size={36} />
