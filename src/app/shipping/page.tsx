...
export const metadata = {
  ...
  description: "Shipping and delivery information for Baby Secret.",
};
  ...
  return (
    <main className="min-h-screen bg-[#f9fcff] pt-36">
      ...
      <div className="mx-auto max-w-3xl px-6 pb-20 sm:px-10">
        ...
        <h1 className="mt-4 text-5xl font-medium">Shipping &amp; delivery</h1>
        <div className="glass-panel mt-10 rounded-2xl p-8">
          ...
          <p className="mt-4 leading-7 text-[#334f6d]">
            {businessContent.policies.shippingStatus}
          </p>
          <p className="mt-4 leading-7 text-[#334f6d]">
            Please contact the Baby Secret team before ordering if you need
            delivery guidance.
          </p>
        </div>
      </div>
