...
export const metadata = {
  title: "Contact Us",
  description: "Contact Baby Secret by phone, email, or message.",
};
  ...
  return (
    <main className="min-h-screen bg-[#f9fcff] pt-36">
      ...
      <div className="mx-auto max-w-3xl px-6 pb-20 sm:px-10">
        ...
        <h1 className="mt-4 text-5xl font-medium">We&apos;re here to help.</h1>
        <p className="mt-4 text-[#334f6d]">
          Questions about products, orders, or finding the right routine? Send
          us a message.
        </p>
